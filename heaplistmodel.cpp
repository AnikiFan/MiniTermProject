    ...
    :heap{base},QAbstractListModel{parent}
{
    ...
    QObject::connect(base,&HeapModel::restarted,this,&HeapListModel::endResetModel);
    QObject::connect(base,&HeapModel::beginResetHeapModel,this,&HeapListModel::beginResetModel);
}
